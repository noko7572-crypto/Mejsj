-- ================================================================
-- MEDI&ABK HUB — RSS Ultimate Pro Full Edition (v2.2)
-- ================================================================
...
local function LaunchRSSHub()
    ...
    TitleLabel.Text = "RSS ULTIMATE HUB v2.2"
    ...
    -- Кнопка сворачивания (открывашка)
    ...
    CreateSwitch("Auto-Dive (Умный нырок влево/вправо)", "AutoDive")
    ...
    -- Стабильный Drawing ESP для мяча
    ...
    RunService.RenderStepped:Connect(function()
        ...
        -- 2. Умный Auto-Dive (Нырок по траектории влево/вправо)
        if getgenv().RSSConfig.AutoDive and ball and root and hum and hum.Health > 0 then
            ...
            if dist <= getgenv().RSSConfig.TriggerDistance then
                ...
                pcall(function()
                    if relativePos.X > 1 then
                        VirtualInputManager:SendKeyEvent(true, Enum.KeyCode.D, false, game)
                        task.wait(0.12)
                        VirtualInputManager:SendKeyEvent(false, Enum.KeyCode.D, false, game)
                    elseif relativePos.X < -1 then
